...
object AetherTray {
    ...
    fun install(actions: TrayActions): Boolean {
        ...
        return runCatching {
            ...
            toggleItem = toggle
            val icon = TrayIcon(createIcon(), "Aether Ng Tunnel", null).apply {
    ...
    fun setConnectionState(connected: Boolean) {
        ...
        runCatching {
            ...
            trayIcon?.toolTip = if (connected) "Aether Ng Tunnel - Connected" else "Aether Ng Tunnel"
        }
    }
    ...
    private fun showCustomPopup(e: MouseEvent, actions: TrayActions) {
        try {
            ...
            val title = JLabel("  Aether Ng Tunnel")
