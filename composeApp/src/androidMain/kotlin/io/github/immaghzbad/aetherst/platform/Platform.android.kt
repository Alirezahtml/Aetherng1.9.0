...
class AndroidSystemUtils(private val context: Context) : SystemUtils {
    ...
    override fun getAppVersion(): String = try { context.packageManager.getPackageInfo(context.packageName, 0).versionName ?: "1.9.0" } catch (_: Exception) { "1.9.0" }
    ...
    override fun copyToClipboard(text: String) {
        ...
        val clip = ClipData.newPlainText("Aether Ng", text)
