...
data class AetherConfig(
    ...
    val wiwOuterPeer: String = "",
    val wiwInnerPeer: String = "",
    val h2Peer: String = "",
    val netstackTcpRx: String = "",
    val netstackTcpTx: String = "",
    val themeMode: AppThemeMode = AppThemeMode.SYSTEM,
    val appLanguage: AppLanguage = AppLanguage.ENGLISH,
    val showLivePingWidget: Boolean = true,
    val showTrafficChartWidget: Boolean = true
)
