...
private const val DeveloperTelegramUrl = "https://t.me/aliem_061"
private const val DeveloperInstagramUrl = "https://instagram.com/Aliem061"
        ...
        LazyColumn(
            ...
            item {
                AboutInfoCard(
                    ...
                    Text(
                        text = "Aether Ng is a native Android client for the Aether tunnel ecosystem. It handles the heavy lifting of managing advanced protocols through a clean interface with real-time stats and simple configuration presets.",
            ...
            item {
                AboutInfoCard(
                    ...
                    AboutLinkCard(
                        ...
                        subtitle = "Follow Aliem061 on Instagram for updates.",
                        url = DeveloperInstagramUrl,
                        urlColor = Color(0xFFE1306C),
                        onClick = { uriHandler.openUri(DeveloperInstagramUrl) },
                        scaleFactor = scaleFactor
                    )
                    Spacer(modifier = Modifier.height((8 * scaleFactor).dp))
                    AboutLinkCard(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            ...
                            Icon(imageVector = Icons.Default.Favorite, contentDescription = null, tint = Color(0xFFFF375F), modifier = Modifier.size((15 * scaleFactor).dp))
                            Text(text = " by PowerSigma Team {Edited by / Aliem}", color = IosSecondaryLabel, fontSize = (13 * scaleFactor).sp)
                        }
                        Spacer(modifier = Modifier.height((8 * scaleFactor).dp))
                        Text(
                            text = "Aether Ng is an independent client project. Aether core is developed by CluvexStudio and distributed under its own open-source license.",
